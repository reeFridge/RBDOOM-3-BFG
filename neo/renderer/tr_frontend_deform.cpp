...
static drawSurf_t* R_AutospriteDeform2( drawSurf_t* surf, viewDef_t* viewDef)
{
	const srfTriangles_t* srcTri = surf->frontEndGeo;
...
static drawSurf_t* R_TubeDeform2( drawSurf_t* surf, viewDef_t* viewDef )
{
	static int edgeVerts[6][2] =
	{
		{ 0, 1 },
...
static drawSurf_t* R_FlareDeform2( drawSurf_t* surf, viewDef_t* viewDef )
{
	const srfTriangles_t* srcTri = surf->frontEndGeo;
...
static drawSurf_t* R_ParticleDeform2( drawSurf_t* surf, bool useArea, nvrhi::ICommandList* commandList, viewDef_t* viewDef_ )
{
	const renderEntity_t* renderEntity = &surf->space->entityDef->parms;
...
drawSurf_t* R_DeformDrawSurf2( drawSurf_t* drawSurf, viewDef_t* viewDef)
{
	...
	return R_DeformDrawSurf2( drawSurf, drawSurf->material->Deform(), viewDef);
}
