...
extern "C" nvrhi::DepthStencilState::StencilOpDesc c_getStencilOpState( uint64 stateBits )
{
...
extern "C" void c_getRenderState(uint64 stateBits, PipelineKey key, nvrhi::RenderState* renderState)
{
	/*
	...
	*/
	...
	{
		nvrhi::DepthStencilState::StencilOpDesc frontStencilOp = c_getStencilOpState( stateBits & GLS_STENCIL_FRONT_OPS );
		frontStencilOp.stencilFunc = stencilFuncOp.stencilFunc;

		nvrhi::DepthStencilState::StencilOpDesc backStencilOp = c_getStencilOpState( ( stateBits & GLS_STENCIL_BACK_OPS ) >> 12 );
	...
	{
		nvrhi::DepthStencilState::StencilOpDesc stencilOp = c_getStencilOpState( stateBits );
